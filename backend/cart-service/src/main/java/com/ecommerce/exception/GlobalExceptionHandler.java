...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(MaxCartLimitExceededException.class)
    public ResponseEntity<ApiResponse<?>> handleMaxCartLimit(MaxCartLimitExceededException ex) {
        return ResponseEntity
    ...
    public ResponseEntity<ApiResponse<?>> handleCartOperation(CartOperationException ex) {
        return ResponseEntity
            .status(HttpStatus.BAD_REQUEST)
            .body(new ApiResponse<>(false, ex.getMessage(), null));
    }
